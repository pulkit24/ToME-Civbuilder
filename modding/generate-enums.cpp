...
int main(int argc, char** argv) {
  ...
  // Generate units enum
  {
    ...
    ofstream outFile(outputDir + "unit_ids.h");
    if (!outFile.is_open()) {
      cerr << "Error: Could not create output file: " << outputDir << "unit_ids.h" << endl;
      return 1;
    }
    ...
    cout << "Generated " << outputDir << "unit_ids.h with " << units.size() << " units" << endl;
  }
